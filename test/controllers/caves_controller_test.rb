...
class CavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cafe" do
    assert_difference('Cafe.count') do
      post caves_url, params: { cafe: { AttendDate: @cafe.AttendDate, Event: @cafe.Event, Event_Id: @cafe.Event_Id, TotalAmount: @cafe.TotalAmount, location: @cafe.location } }
    end
  ...
  test "should update cafe" do
    patch cafe_url(@cafe), params: { cafe: { AttendDate: @cafe.AttendDate, Event: @cafe.Event, Event_Id: @cafe.Event_Id, TotalAmount: @cafe.TotalAmount, location: @cafe.location } }
